...
export class DataService {
  ...
  dataArray: UserData[] = [
    { id: 1, name: "Oliver L.", progress: 15, color: "aqua" },
    { id: 2, name: "Violet I.", progress: 80, color: "orange" },
    { id: 3, name: "Cora O.", progress: 18, color: "purple" },
    { id: 4, name: "Amelia V.", progress: 50, color: "teal" },
    { id: 5, name: "Charlotte C.", progress: 97, color: "red" },
    { id: 6, name: "Arthur T.", progress: 53, color: "aqua" },
    { id: 7, name: "Isabella C.", progress: 27, color: "navy" },
    { id: 8, name: "Amelia I.", progress: 68, color: "olive" },
    { id: 9, name: "Theodore V.", progress: 31, color: "fuchsia" },
    { id: 10, name: "Theodore A.", progress: 82, color: "teal" },
    { id: 11, name: "Thomas C.", progress: 20, color: "yellow" }
