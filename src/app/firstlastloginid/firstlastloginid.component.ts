...
import { NamesWithLoginId } from '../models/nameswithloginid';
import { MatSelect } from '@angular/material';

@Component({
  selector: 'app-firstlastloginid',
  templateUrl: './firstlastloginid.component.html',
  styleUrls: ['./firstlastloginid.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => FirstlastloginidComponent),
      multi: true
    }
  ]
})
export class FirstlastloginidComponent implements OnInit {
  ...
  public filteredOptions: ReplaySubject<NamesWithLoginId[]> = new ReplaySubject<NamesWithLoginId[]>(1);
